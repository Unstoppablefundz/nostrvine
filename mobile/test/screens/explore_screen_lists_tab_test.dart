...
void main() {
  group('ExploreScreen Lists Tab Structure TDD', () {
    test(
      'RED: ExploreScreen should have 3 tabs, not 4',
      () {
        ...
        expect(expectedTabCount, 3,
          reason: 'ExploreScreen should have exactly 3 tabs after removing Divine Team');
      },
    );

    test(
      'RED: Tab labels should be [New Videos, Popular Videos, Lists]',
      () {
        ...
        expect(expectedTabs.length, 3,
            reason: 'Should have exactly 3 tab labels');
        expect(expectedTabs[0], 'New Videos',
            reason: 'First tab should be New Videos');
        expect(expectedTabs[1], 'Popular Videos',
            reason: 'Second tab should be Popular Videos');
        expect(expectedTabs[2], 'Lists',
