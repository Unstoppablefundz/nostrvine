...
class MockVideoEventService extends _i1.Mock implements _i4.VideoEventService {
  ...
  @override
  List<_i5.VideoEvent> get homeFeedVideos => (super.noSuchMethod(
        Invocation.getter(#homeFeedVideos),
        returnValue: <_i5.VideoEvent>[],
      ) as List<_i5.VideoEvent>);

  @override
  List<_i5.VideoEvent> get discoveryVideos => (super.noSuchMethod(
        Invocation.getter(#discoveryVideos),
        returnValue: <_i5.VideoEvent>[],
      ) as List<_i5.VideoEvent>);

  @override
  List<_i5.VideoEvent> get profileVideos => (super.noSuchMethod(
        Invocation.getter(#profileVideos),
        returnValue: <_i5.VideoEvent>[],
      ) as List<_i5.VideoEvent>);

  @override
  List<_i5.VideoEvent> get editorialVideos => (super.noSuchMethod(
        Invocation.getter(#editorialVideos),
        returnValue: <_i5.VideoEvent>[],
      ) as List<_i5.VideoEvent>);

  @override
  List<_i5.VideoEvent> get popularNowVideos => (super.noSuchMethod(
        Invocation.getter(#popularNowVideos),
        returnValue: <_i5.VideoEvent>[],
      ) as List<_i5.VideoEvent>);

  @override
  List<_i5.VideoEvent> get trendingVideos => (super.noSuchMethod(
        Invocation.getter(#trendingVideos),
        returnValue: <_i5.VideoEvent>[],
      ) as List<_i5.VideoEvent>);

  @override
  List<_i5.VideoEvent> get hashtagVideos => (super.noSuchMethod(
        Invocation.getter(#hashtagVideos),
        returnValue: <_i5.VideoEvent>[],
      ) as List<_i5.VideoEvent>);

  @override
  List<_i5.VideoEvent> get searchResults => (super.noSuchMethod(
        Invocation.getter(#searchResults),
        returnValue: <_i5.VideoEvent>[],
      ) as List<_i5.VideoEvent>);

  @override
  List<_i5.VideoEvent> get videoEvents => (super.noSuchMethod(
  ...
  @override
  bool hasEvents(_i4.SubscriptionType? type) => (super.noSuchMethod(
        Invocation.method(
          #hasEvents,
          [type],
        ),
  ...
  @override
  int getEventCount(_i4.SubscriptionType? type) => (super.noSuchMethod(
        Invocation.method(
          #getEventCount,
          [type],
        ),
  ...
  @override
  bool isSubscribed(_i4.SubscriptionType? type) => (super.noSuchMethod(
        Invocation.method(
          #isSubscribed,
          [type],
        ),
  ...
  @override
  List<_i5.VideoEvent> getVideosByAuthor(String? pubkey) => (super.noSuchMethod(
        Invocation.method(
          #getVideosByAuthor,
          [pubkey],
        ),
  ...
  @override
  _i8.Future<void> subscribeToUserVideos(
    String? pubkey, {
    int? limit = 50,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i8.Future<void> refreshVideoFeed() => (super.noSuchMethod(
        Invocation.method(
          #refreshVideoFeed,
          [],
        ),
  ...
  @override
  _i8.Future<void> loadMoreVideos({int? limit = 100}) => (super.noSuchMethod(
        Invocation.method(
          #loadMoreVideos,
          [],
          {#limit: limit},
  ...
  @override
  _i8.Future<void> unsubscribeFromVideoFeed() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  List<_i5.VideoEvent> getVideoEventsByEngagement() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i8.Future<void> retrySubscription() => (super.noSuchMethod(
        Invocation.method(
          #retrySubscription,
          [],
        ),
...
class MockINostrService extends _i1.Mock implements _i3.INostrService {
  ...
  @override
  _i8.Stream<Map<String, bool>> get authStateStream => (super.noSuchMethod(
...
class MockSubscriptionManager extends _i1.Mock
  ...
  @override
  _i8.Future<void> cancelAllSubscriptions() => (super.noSuchMethod(
        Invocation.method(
