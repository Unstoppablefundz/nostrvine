...
// in openvine/test/services/camera/circular_recording_bug_test.dart.
...
class MockXFile extends _i1.Mock implements _i2.XFile {
  ...
  @override
  _i6.Future<_i11.Uint8List> readAsBytes() => (super.noSuchMethod(
        Invocation.method(
          #readAsBytes,
          [],
        ),
  ...
  @override
  _i6.Stream<_i11.Uint8List> openRead([
    int? start,
    int? end,
  ]) =>
      (super.noSuchMethod(
        ...
        returnValue: _i6.Stream<_i11.Uint8List>.empty(),
      ) as _i6.Stream<_i11.Uint8List>);
  ...
  _i6.Future<DateTime> lastModified() => (super.noSuchMethod(
        ...
        returnValue: _i6.Future<DateTime>.value(_FakeDateTime_5(
          this,
          Invocation.method(
            #lastModified,
            [],
