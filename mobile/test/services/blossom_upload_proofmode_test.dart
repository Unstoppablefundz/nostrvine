...
void main() {
  ...
  group('BlossomUploadService ProofMode Integration', () {
    ...
    test('should include ProofMode headers when ProofManifest is provided', () async {
      // Arrange
      ...
      when(() => mockResponse.data).thenReturn({
        ...
        'proofmode': {
          ...
          'timestamp': DateTime(2025, 10, 13, 10, 0).millisecondsSinceEpoch ~/ 1000,
        },
      });
      ...
      final capturedCall = verify(() => mockDio.put(
    ...
    test('should upload without ProofMode headers when no manifest provided', () async {
      // Arrange
      const testPublicKey = '0223456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef';
    ...
    test('should fix missing file extension in image upload conflict response', () async {
      // Arrange
      const testPublicKey = '0223456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef';
      ...
      when(() => mockFile.readAsBytesSync()).thenReturn(Uint8List.fromList([1, 2, 3]));
      ...
      expect(result.cdnUrl, equals('https://cdn.divine.video/039058c6f2c0cb492c533b0a4d14ef77cc0f78abccced5287d84a1a2011cfb81.jpg'));
    });
  });
}
